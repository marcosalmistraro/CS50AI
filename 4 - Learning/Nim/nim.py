...
class NimAI():
    ...
    def best_future_reward(self, state):
        ...
        `state`, return 0.
        """
        # Initialize best_q_value as 0
        best_q_value = 0

        # Loop over all possible actions starting from a given state
        for action in Nim.available_actions(state):

            # Update best_q_value if a better possibility arises
    ...
    def choose_action(self, state, epsilon=True):
        ...
        """
        # Initialize best action as None
        best_available_action = None
        ...
        for action in Nim.available_actions(state):
            if self.get_q_value(state, action) > best_q:
                ...
                best_available_action = action
        return best_available_action
